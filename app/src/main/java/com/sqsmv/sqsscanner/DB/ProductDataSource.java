...
import com.sqsmv.sqsscanner.Product;
...
public class ProductDataSource implements DataSource
{
    ...
    {
        final SQLiteStatement query = db.compileStatement(INSERT_QUERY);
        db.beginTransaction();
        try
        {
            query.clearBindings();
    ...
    {
        return db.delete(DB_TABLE, prodCols[0] + " = " + Integer.toString(masNum), null) > 0;
    }
    ...
    public boolean updateProduct(Product product)
    {
        ...
        return db.update(DB_TABLE, val, prodCols[0] + " = " + Integer.toString(product.getMasNum()), null) > 0;
    }
